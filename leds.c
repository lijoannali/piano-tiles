...
void InitializeLEDInterface(void) {
    ...
    // IOMUX->SECCFG.PINCM[(IOMUX_PINCM20)] = IOMUX_PINCM_PC_CONNECTED | IOMUX_PINCM20_PF_GPIOA_DIO09;  // SPI0_PICO on PA9
    IOMUX->SECCFG.PINCM[(IOMUX_PINCM20)] = IOMUX_PINCM_PC_CONNECTED | IOMUX_PINCM20_PF_SPI0_PICO;  // SPI0_PICO on PA9
    IOMUX->SECCFG.PINCM[(IOMUX_PINCM59)] = IOMUX_PINCM_PC_CONNECTED | 0x1;  //PA26 for testing
